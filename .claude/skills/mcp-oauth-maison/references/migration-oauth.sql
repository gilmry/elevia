...
--
-- Copié tel quel depuis Elevia (backend/migrations/0002_oauth.sql) à titre
-- d'exemple concret. Remplacer `utilisateurs(id)` par la table utilisateurs
-- réelle du projet cible avant d'appliquer cette migration.
